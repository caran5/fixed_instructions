"""
DeepChem - Featurize Molecules Tool Description
"""
...
tool_description = {
    ...
    "time_complexity": {
        ...
        "latency_seconds": {
            "n1": 0.01,  # Single molecule, CircularFingerprint
            "n100": 0.8,  # 100 molecules
            "n1000": 7.5,  # 1000 molecules  
            "n10000": 75,  # 10K molecules
            "n1_graph": 0.03,  # Single molecule, graph featurizer
            "n100_graph": 2.5,  # 100 molecules, graph
            "n1000_parallel": 2.0,  # 1000 molecules, n_jobs=-1 (8 cores)
        },
    },
    "outputs": {
        "type": "numpy.ndarray",
