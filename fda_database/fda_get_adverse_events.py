"""
FDA Database - Get Adverse Events Tool Description
"""
...
tool_description = {
    ...
    "optional_parameters": [
        {
            ...
            "description": (
                ...
                "Filters on 'receivedate' field. If None, returns all available dates."
            ),
        },
        {
            "name": "reaction",
            ...
            "description": (
                ...
                "If None, returns all reactions for the drug."
            ),
        },
        {
            "name": "serious_only",
    ...
    "time_complexity": {
        ...
        "latency_seconds": {
            "n1": 0.8,  # Single query, limit=100
            "n2": 1.6,  # Two sequential queries
            "n10": 8.0,  # Ten sequential queries
            "batch_10": 3.5,  # Parallelized with asyncio
            "large_query": 1.5,  # Single query with limit=1000
        },
    },
    "outputs": {
        "type": "dict",
            ...
            "results": [
                {
                    ...
                    "patient": {
                        "reaction": [{"reactionmeddrapt": "NAUSEA"}, {"reactionmeddrapt": "VOMITING"}],
                        "drug": [
