"""
TorchDrug - Create Graph Neural Network Model Tool Description
"""
...
tool_description = {
    ...
    "optional_parameters": [
        {
            ...
            "description": (
                ...
                "If None, model ignores edge features (faster but less accurate). "
        ...
        },
        {
            ...
            "description": (
                ...
                "If None, treats all edges as same type."
            ),
        },
        {
            "name": "batch_norm",
    ...
    "time_complexity": {
        ...
        "latency_seconds": {
            "creation": 0.05,  # Model instantiation
            "inference_1_cpu": 0.15,  # 1 molecule, CPU
            "inference_32_cpu": 2.5,  # 32 molecules (batch), CPU
            "inference_1_gpu": 0.003,  # 1 molecule, GPU
            "inference_32_gpu": 0.02,  # 32 molecules (batch), GPU
            "inference_1000_gpu": 0.4,  # 1000 molecules (batch), GPU
        },
    },
    "outputs": {
